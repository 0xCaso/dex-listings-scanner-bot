...
export declare class Context<U extends Deunionize<tg.Update> = tg.Update> {
     ...
     */
    approveChatJoinRequest(this: Context, chatId: number | string, userId: number): Promise<true>;
    /**
     * @see https://core.telegram.org/bots/api#declinechatjoinrequest
     */
    declineChatJoinRequest(this: Context, chatId: number | string, userId: number): Promise<true>;
    /**
