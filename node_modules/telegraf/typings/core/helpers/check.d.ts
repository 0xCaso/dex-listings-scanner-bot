 ...
 */
export declare function hasProp<O extends {}, K extends PropertyKey>(obj: O | undefined, prop: K): obj is O & Record<K, unknown>;
/**
 * Checks if a given object has a property with a given name.
 ...
 */
export declare function hasPropType<O extends {}, K extends PropertyKey, T extends keyof Mapping, V extends Mapping[T]>(obj: O | undefined, prop: K, type: T): obj is O & Record<K, V>;
/**
